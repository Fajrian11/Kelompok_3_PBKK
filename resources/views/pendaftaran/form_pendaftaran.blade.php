  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
            <form action="/save-pendaftaran" method="post">
                {{ csrf_field() }}

            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nama Pasien</label>
                <div class="col-sm-8">
                    <input type="text" name="nm_pasien" id="nm_pasien" class="form-control" placeholder="Masukkan Nama Pasien...">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Jenis Kelamin</label>
                <div class="col-sm-8">
                    <input type="text" name="jns_kelamin" id="jns_kelamin" class="form-control" placeholder="Masukkan Jenis Kelamin...">
                </div>
           </div>
